...
1. Go to the [Rolling Relese workflow](https://github.com/pedro-psb/dynaconf/actions/workflows/release-rolling.yml)
...
1. Go to the [Backport Release workflow](https://github.com/pedro-psb/dynaconf/actions/workflows/release-backport.yml)
2. Enter the expected next version (as shown in check-releases)
3. Click the button
...
If the release succeded but the publish fails (or if a manual release is required by some reason),

...
- bump version to 3.4.3-dev0. *By pedro-psb*.

## [3.4.2](https://github.com/pedro-psb/dynaconf/releases/tag/3.4.2) - 2026-06-22

### Bug Fixes

- dummy bugfix Y. *By Pedro Brochado*.
- dummy bugfix X. *By Pedro Brochado*.
...
- some bar fix. *By Pedro Brochado*.
- some foo fix. *By Pedro Brochado*.

### Chore

- bump version to 3.4.1-dev0. *By pedro-psb*.

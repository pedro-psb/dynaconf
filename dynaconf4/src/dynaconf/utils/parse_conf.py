...
converters = {
    "@str": lambda value: (
        value.set_casting(str) if isinstance(value, Lazy) else str(value)
    ),
    "@int": lambda value: (
        value.set_casting(int) if isinstance(value, Lazy) else int(value)
    ),
    "@float": lambda value: (
        value.set_casting(float) if isinstance(value, Lazy) else float(value)
    ),
    "@bool": lambda value: (
